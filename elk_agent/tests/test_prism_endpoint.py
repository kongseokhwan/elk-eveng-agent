...
class TestprismEndpointFailures(base.TestprismFailures):
...
@ddt.ddt
class TestprismEndpointCreateFailures(TestprismEndpointFailures):
    ...
    def test_create_endpoint_port_failures(self, GivenException):
        ...
        # The port creation is failed and prism rolles the created subnet back.
...
@ddt.ddt
class TestprismEndpointDeleteFailures(TestprismEndpointFailures):
