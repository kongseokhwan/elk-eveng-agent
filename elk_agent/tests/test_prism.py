...
@ddt.ddt
class Testprism(base.TestprismBase):
    ...
    def test_network_driver_create_endpoint_with_v4_subnetpool(self):
        ...
        fake_prism_subnetpool_id = str(uuid.uuid4())
        prism_subnetpools = self._get_fake_v4_subnetpools(
            fake_prism_subnetpool_id)
        app.neutron.list_subnetpools(name='prism').AndReturn(prism_subnetpools)
        app.neutron.list_subnetpools(
            name='prism6').AndReturn({'subnetpools': []})
        ...
        fake_subnet_request = {
            "subnets": [{
                ...
                'network_id': fake_neutron_network_id,
                'ip_version': 4,
                'subnetpool_id': fake_prism_subnetpool_id
            }]
        }
    ...
    def test_network_driver_create_endpoint_with_subnetpools(self):
        ...
        fake_prism6_subnetpool_id = str(uuid.uuid4())
        prism6_subnetpools = self._get_fake_v6_subnetpools(
            fake_prism6_subnetpool_id)
        app.neutron.list_subnetpools(
            name='prism6').AndReturn(prism6_subnetpools)
        ...
        fake_subnet_request = {
            "subnets": [{
                ...
                'network_id': fake_neutron_network_id,
                'ip_version': 6,
                'subnetpool_id': fake_prism6_subnetpool_id
            }]
        }
        # The following fake response is retrieved from the Neutron doc:
