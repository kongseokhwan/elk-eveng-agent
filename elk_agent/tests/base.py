...
class TestprismBase(TestCase):
    """Base class for all prism unittests."""

    def setUp(self):
        super(TestprismBase, self).setUp()
...
class TestprismFailures(TestprismBase):
    """Unitests for checking if prism handles the failures appropriately."""
